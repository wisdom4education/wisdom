...
var game = {
    ...
    loadQuestion: function (){
        ...
        for(var i=0;i<questions[game.currentQuestion].answers.length;i++){
            $('#subwrapper').append('<button class="btn-outline-primary answer-button id="button- '+i+'" data-name="'+questions[game.currentQuestion].answers[i]+'">'+questions[game.currentQuestion].answers[i]+'</button>');
        }
    },
    ...
    results: function(){
        ...
        $('#subwrapper').append(" <h3>Correct: " +game.correct + '<br/></h3><h3>');
        $('#subwrapper').append(" <h3>Incorrect: " +game.incorrect + '<br/></h3>');
        $('#subwrapper').append(" <h3>Unanswered: " +game.unanswered + '<br/></h3>');
        $('#subwrapper').append("<button id= reset class=btn-primary>Try again?</button>")
